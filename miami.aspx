<%@ Page Title="Miami" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="miami.aspx.cs" Inherits="miami" EnableEventValidation="false"  ValidateRequest = "false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">

 <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Sell My Car For Cash Miami | Cash For Car | Buy car Miami</title>
<link rel="canonical" href="http://183.82.32.95:8079/miami.aspx" />		
		<meta name="keywords" content="Sell My car Miami,car buyers Miami,sell my car for cash miami,sell my motorcycle miami,sell my used car miami,cash for car miami" />

        <meta name="title" content="Sell My Car For Cash Miami | Cash For Car | Buy car Miami" />
		<meta name="description" content="Sell Your Car ,Sell Your SUV, Cash For Trucks or motorcycle today! AutoBuy in Miami will pay THE MAX for your vehicle! Free appraisals and we come to you!" />
...
<div id="image-location" class="col-md-6" style="padding:0">
  <img id="img-display" class="animated zoomIn" src="image/miami-factory-loc.jpg" alt="miami carbuyers"/>
</div>
                        ...
                        <div id="second-section" class="col-md-12 col-sm-12 col-xs-12">
                            <div class="col-md-5 col-sm-6 col-xs-12" style="">
                                <div class="img-review">
                                    <figure>
                            <img src="image/miami-place.png" alt="Sell Your Car Miami" style="width:auto"/>
                           ...
                           <%-- <div class="miami-text">
                                ...
                                <div class="miami-text">
                                    ...
                                    <p>
                                       2001 NW 167th ST, Miami Gardens, <span>FL 33056</span>
                                    </p>
                                </div>
                                <div class="miami-button">
                ...
                <div class="container">
                    <div id="third-section" class="col-md-12 col-sm-12 col-xs-12">
                        <div class="miami-content">
                            <h4>
                                AUTOBUY | SELL YOUR CAR IN MIAMI, FL 33056</h4>
                            <p>
                                Looking to sell your car for cash in Miami? The expert Miami car buyers at AUTOBUY
                                will pay the max for your car. We provide the quickest and simplest car buying experience
                                and our vehicle appraisers will come to you!
                            </p>
                            <p>
                                Call us at <span style="color: #274e9d; font-weight: bold">305-363-3161 </span>or
                                send an email and one of our experienced staff members will help you set up a free
                                appraisal. A certified AUTOBUY inspector will come to your home or office and make
                                you a written offer to buy your car.</p>
                            <p>
                                Our Miami car buyers will pay cash for your car, truck, SUV, motorcycle or commercial
                                vehicle!</p>
                        </div>
                    </div>
                </div>
            ...
            if (fName.length != 0 && lName.length != 0 && email.length != 0 && phone.length != 0 && optionSellocation != 0) {
                ...
                if (atpos < 1 || dotpos < atpos + 2 || dotpos + 2 >= x.length) {
                    ...
                    if (document.getElementById("<%=hidden_leadid.ClientID%>").value == "") {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "miami.aspx/buttonNxt_Click",
