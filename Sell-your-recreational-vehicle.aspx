<%@ Page Title="Sell Your recreational vehicles" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Sell-your-recreational-vehicle.aspx.cs" Inherits="Sell_your_recreational_vehicle" EnableEventValidation="false"  ValidateRequest = "false" %>
...
<!-- Basic Page Needs
  ...
  <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>sell your Motorhome | Sell my campervan | sell my RV today</title>
    <link rel="canonical" href="http://183.82.32.95:8079/Sell-your-recreational-vehicle.aspx" />
    <meta name="keywords" content="sell used rv, buy campervan, buy rv" />
    <meta name="title" content="sell your Motorhome | Sell my campervan | sell my RV today" />
    <meta name="description" content="With locations in Fort Lauderdale, Melbourne, West Palm Beach, Miami, Stuart, Daytona, Orlando & Sanford, AutoBuy is the fastest way to sell your recreational vehicle." />
<link rel="icon" href="image/autobuylogo_favi.png" />
   ...
   .icon_vehicles-border {
    color: #FB3943;
    border: 2px solid #FB3943 !important;
}
a.inner-submit {
    margin-right: 0;
}
...
<div id="image-wrapper" class="col-md-6" style="padding:0">
  <img id="img-display" class="animated zoomIn" src="image/rv_page_img.jpg" alt="campervan buyers" style="width:auto"/>
</div>
...
<asp:HiddenField runat="server" ID="hidden_leadid" Value="" />
 ...
 <span id="veh_mandatory1"  style="color:red;display:none;font-size:11px"  >Enter the valid year</span>
  ...
  <a  class="inner-submit"  onclick="return source();" id="vehicle_info_next"  >Get Started</a>
    ...
    font-size: 20px;"></span>&nbsp;&nbsp;<span style="color: #e74c3c;"><a href="tel:8884288381" style="color:#d23a2e;"><span>(888)428-8381</span></a></span></h3> 
    </div>
    </div>
</div>
    </div>
...
<div class="container-fluid fast-steps">
        ...
        <ul>
            <li id="sell-form-recreational" class="btn-sell btn-labeled-sell btn-default" style="margin-top:40px;"><span class="btn-label-sell"><i class="glyphicon glyphicon-chevron-right"></i></span><a href="javascript:void(0)" style="color:#000;font-weight:bold;text-transform: uppercase;">Submit Your Vehicle</a></li>
        </ul>
     </div>--%>
                    </div>
                </div>
        ...
        <div class="container">    
            <div id="third-section" class="col-md-12 col-sm-12 sell col-xs-12"> 	
                    <div class="heading" style="padding-top:0px;padding-bottom:20px;">
                        <h2 class="sellmycar">AUTOBUY, the "<span style="color:#e74c3c">Sell My Rv's</span>" Company!</h2>
		            </div>
                <div class="miami-content">
                       
                       <p>
                       
                       The major reason why you think “I have to sell my RV” is that you would rather have cash at hand than

have an RV eating up your garage space. In the United States, there are more Rv's sold than bought. This

creates a difficult situation if you are looking to sell your motorhome. AUTOBUY makes selling used Rv's

an easy, fast and a pain free experience.
                       
                       
                       
                       Rv's, motorhomes and camper vans are highly customized vehicles, designed and built as per the users’

specifications and needs. This is what makes selling used Rv's difficult. Usually, a dealer would appraise

your vehicle inappropriately and you would end up getting back much lesser cash than the market value

of your vehicle. At AUTOBUY, we value our customers’ interests and we always pay the max.
                       
                       </p>
                        <p>
                       
                       Started in 2010, AUTOBUY has now grown into becoming the Nation’s number one automobile buyer.

We have unmatched experience in buying Recreational vehicles. Our professionals are highly trained to

help you sell your camper van fast and easy. Our fine-tuned system and method of functioning ensures

you get the most money for your vehicle and fast.
                      
                       
                       Since the market for buying used Rv's is very specific, it usually takes a long time to sell your RV on your

own. Even dealers find it difficult to get suitable buyers for Rv's within stipulated time. Motorhomes

that aren’t sold for long period of time reduce in value substantially. However, with AUTOBUY, we pay

the maximum price for your RV and purchase it the fastest.
                       
                       </p>
                        <p>
                       
                       To sell your RV in the fastest way, call 
<span style="color:#274e9d;font-weight:bold"><a href="tel:8884288381">888-428-8381</a>.</span> right now and book and appointment for appraisal.

An AUTOBUY profession will process the information about your vehicle and give you an appointment at

a time and place of your convenience. You can choose to get your vehicle appraised either from your

home or at work. An AUTOBUY certified appraiser would inspect your vehicle within 20 minutes and

man an offer for your vehicle.
                       
                       
                       If you like our offer, you can sell your RV and get your cash at hand instantly. With AUTOBUY, you don’t

have to wait patiently for months together to sell your vehicle while it collects rust and reduces in value.

AUTOBUY is the fastest way to sell your RV for the max.
                       
                       
                       </p>
                        <p>
                       
                       Over the years, AUTOBUY has served over 52,000 + happy customers across the country, and have made

vehicle inventory appraisals over $1 Billion. We are the nation’s premium car buying company and we

buy all vehicles ranging from cars and motorcycles to Commercial vehicles, RV’s and boats. With

Unrivalled experience and unmatched service, AUTOBUY is the best place to sell your camper van for
                ...
                if (atpos < 1 || dotpos < atpos + 2 || dotpos + 2 >= x.length) {
                    ...
                    if (document.getElementById("<%=hidden_leadid.ClientID%>").value == "") {
                      //  document.getElementById("inner-submit_next").disabled = false;
                        ...
                        $.ajax({
                            type: "POST",
                            url: "Sell-your-recreational-vehicle.aspx/buttonNxt_Click",
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('.form-menu').show();
        $('#change-icon-class').addClass('icon-Rv icon_vehicles-border');
        ...
        $('.badge-1').css('background', '#FB3943', 'color', '#ffffff');
        $('#select-icon').addClass('fa fa-check');
        $('#change-icon-class').removeClass('icon-car icon-bike icon-boat icon-cv');
        $('#change-icon-class,#select-icon').show();
        $('.inner-container h3').css('background', '#FB3943');
        $('.button-menu').toggleClass('red-tab h2');
        $('a.inner-submit').css('background', 'url(image/submit-arrow.png) #FB3943');
        $('a.inner-submit').css('background-repeat', 'no-repeat');
        $('a.inner-submit').css('background-position', '85% 11px');
        $('a.inner-cancel').css('border', '2px solid #FB3943');
        $('a.inner-cancel').css('color', '#FB3943');
        $('a.inner-cancel').toggleClass('cancel-red');
        $('input.step1').css('background', '#FB3943');
        $('.button-menu').removeClass('orange-tab h2 yellow-tab h2 green-tab h2 blue-tab h2');
        $('a.inner-cancel').removeClass('cancel-orange cancel-yellow cancel-green cancel-blue');
