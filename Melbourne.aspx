<%@ Page Title="Melbourne" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Melbourne.aspx.cs" Inherits="Melbourne"  EnableEventValidation="false"  ValidateRequest = "false"%>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">

 <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>Melbourne Car Buyers | cash for cars melbourne | Autobuy</title>
		<link rel="canonical" href="http://183.82.32.95:8079/Melbourne.aspx" />
		<meta name="keywords" content="Sell My car melbourne,cash for car melbourne,sell used car  melbourne,auto buy, car buyers melbourne, sell my car melbourne" />

        <meta name="title" content="Melbourne Car Buyers | cash for cars melbourne | Autobuy" />
		<meta name="description" content="Sell your car, Sell your truck, Sell your Suv's or Motorcycle today! AutoBuy in Melbourne will pay THE MAX for your vehicle! Free appraisals and we come to you!" />
...
<div id="image-location" class="col-md-6" style="padding:0">
  <img id="img-display" class="animated zoomIn" src="image/melbourne-factory-loc.jpg" alt="cash for car melbourne"/>
</div>
...
<!--                    <span id="show-icon-text-3">RV's</span>-->
				...
				<li id="showform2" class="col-md-2 col-xs-2" style="padding-left:0" 
onclick="type_Fleet()"><a href="javascript:void(0)"  class="cvs" title="Submit your Vehicle">
...
<div id="second-section" class="col-md-12 col-xs-12 col-sm-12">			
                <div class="col-md-5 col-sm-6 col-xs-12" style="">
                    <div class="img-review">
                         <figure>
                            <img src="image/melbourne-place.png" alt="sell my car melbourne" style="width:auto"/ >
                            <figcaption style="margin-top:-5%"><!--<h4 style="color:#fff">MIAMI</h4><br>-->
                                <div class="miami-button">
                                    <a href="https://www.google.co.in/search?q=google+my+business&rlz=1C1CHWA_enIN652IN652&oq=google+my+bu&aqs=chrome.0.0j69i60l3j69i57j0.4594j0j7&sourceid=chrome&ie=UTF-8#q=autobuy+melbourne&lrd=0x88de11f143270a6f:0x4c0312dbc7c4ab72,1" target="_blank">
                ...
                <%-- <div class="miami-text">
                    ...
                    <div class="miami-text">
                        ...
                        <p>Mon-Fri &nbsp; 9AM - 7PM EST | Sat &nbsp; 9AM - 6PM EST | <span>Sun &nbsp; By Appointment Only</span> </p>
                     </div>
                    <div class="miami-text">
                        <h4>call us @ 321-206-3887 </h4>
                        <p>223 East New Haven Ave, Melbourne, <span>FL 32901</span> </p>
                     </div>
                    <div class="miami-button">
                        <a href="https://www.google.com/maps/place/223+E+New+Haven+Ave,+Melbourne,+FL+32901/@28.0783451,-80.6189772,17z/data=!3m1!4b1!4m5!3m4!1s0x88de11f1432a7167:0x5e6ed928c63bd537!8m2!3d28.0783451!4d-80.6167885" target="_blank">
        ...
        <div class="container">    
            <div id="third-section" class="col-md-12 col-xs-12 col-sm-12"> 			    
                <div class="miami-content">
                        <h4>AUTOBUY | GET CASH FOR YOUR CAR IN MELBOURNE, FL 32901</h4>
                        <p>Ready to upgrade your ride but need to sell your car in Melbourne? The car buyers at AUTOBUY in Melbourne, Florida are ready to take that vehicle off your hands. We will make you a cash offer for your car, truck, SUV or motorcycle. At AUTOBUY, we pay the most money for your car so, you can rest assured you are getting the best price.</p>
                    
                    <p>AUTOBUY makes selling your car in Melbourne easy and convenient. Our car buying process is straightforward. Call us at <span style="color:#274e9d;font-weight:bold">(561) 797-2400</span> to set up an appointment for your vehicle appraisal. Our certified Melbourne car inspectors will come to your home or office and give you cash for your car on the spot. There's no pressure to accept immediately - you have up to 5 days to decide.</p>
                    
                    <p>Sell your car for the max in Melbourne, Florida! Call or email one of our expert AUTOBUY car buyers today.</p>
                </div>
            </div>
        </div>    
</div>
...
<div class="container-fluid" style="background:#303030;clear: left;margin-top:0px;">
        <div class="miami-text">
            <h4 style="margin-bottom:0px;padding:30px">melbourne contact details</h4>
        </div>
</div>
                ...
                return false;
                    ...
                    if (document.getElementById("<%=hidden_leadid.ClientID%>").value == "") {
                      //  document.getElementById("inner-submit_next").disabled = false;
                        ...
                        $.ajax({
                            type: "POST",
                            url: "Melbourne.aspx/buttonNxt_Click",
