<%@ Page Title="The New Way to Sell Your Truck For Max | AutoBuy" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="sell-your-truck-for-max.aspx.cs" Inherits="sell_your_truck_for_max" EnableEventValidation="false"  ValidateRequest = "false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />

  <meta name="description" content="Sell your truck to AutoBuy for the MAX. We provide the free appraisal and written offer to buy in 20 mins or less. We will buy your truck the same day on the spot" />
  <meta name="keywords" content="Sell my truck,truckmax,buy a truck,used trucks near me,whats my truck worth,cash for trucks" />
...
<div id="article-div" class="miami-content">
    <h1>Sell Your Truck for Max in South Florida | AUTOBUY</h1>
 </div>
<img class="col-md-8 col-md-offset-2" src="image/article-3.jpg" alt="buy truck" style="margin-bottom:25px;"/>
<div id="" class="col-md-8 col-md-offset-2">
        <div class="miami-content">
            <ul>
                <li id="sell-form-article-3" class="btn-sell btn-labeled-sell btn-default" style="margin-top:0;margin-bottom:12px;">
        ...
        <div class="miami-content">
           <p>If you say “I want to Sell My truck for Max” AUTOBUY is the best choice for you. We buy all type of vehicle including Car, Truck, SUV, Commercial Vehicle or even a Speed Boat. We have a convenient location all around South Florida. We will buy any truck you have and pay you on the spot the same day. We are the best choice when you want max for your truck fast.</p>
           <p>At AUTOBUY, we have a transparent approach the buying trucks. We have a dedicated team of truck buyers who are ready to do a free appraisal  which takes less than 20 minutes. You will be given an offer to buy instantly! Ours is an obligation free offer.</p>
            <p>We have the most customer friendly staff with us. They are here to answer all your queries when selling your truck. So, if you are ready to sell your truck but don’t hold title. Do not worry! We will handle all the payoffs involved to get you the Max.</p>
            
            <p>We have shops in eight convenient location in Miami, West Palm Beach, Stuart, Melbourne, Fort Lauderdale, Daytona, Orlando and Sanford. If you already hold an offer from any of our competitors bring it to us. We will beat their offer and pay the MAXIMUM. Call us today to know more.</p>
                ...
                return false;
                    ...
                    if (document.getElementById("<%=hidden_leadid.ClientID%>").value == "") {
                      //  document.getElementById("inner-submit_next").disabled = false;
                        ...
                        $.ajax({
                            type: "POST",
                            url: "sell-your-truck-for-max.aspx/buttonNxt_Click",
