<%@ Page Title="Sell my car sanford" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Sell-my-car-sanford.aspx.cs" Inherits="Sell_my_car_sanford" EnableEventValidation="false" ValidateRequest = "false"%>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">

<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>selling your car sanford | sell my car Sanford | Autobuy</title>
<link rel="canonical" href="http://183.82.32.95:8079/Sell-my-car-sanford.aspx" />
		<meta name="keywords" content="Buy My Car Sanford,Car Buying Company Sanford,Sell My Car Sanford" />

        <meta name="title" content="selling your car sanford | sell my car Sanford | Autobuy" />
		<meta name="description" content="Sell your car truck SUV or motorcycle today! AutoBuy Sell my car in Sanford will pay THE MAX for your vehicle! Free appraisals and we come to you!" />
...
<div id="image-location" class="col-md-6" style="padding:0">
  <img id="img-display" class="animated zoomIn" src="image/sanford-new.jpg" alt="Cash for Cars in Sanford"/>
</div>
                         ...
                         <figure>
                            ...
                            <figcaption style="margin-top:-5%"><!--<h4 style="color:#fff">ORLANDO</h4><br>-->
                                <div class="miami-button">
                                    <a href="https://www.google.co.in/search?q=autobuy+sanford&rlz=1C1CHWA_enIN652IN652&oq=autobuy+sanfo&aqs=chrome.0.69i59j69i57j69i60j69i61.4931j0j7&sourceid=chrome&ie=UTF-8#lrd=0x88e712fad7e1bcf7:0xbc69f820071149fc,3" target="_blank">
                ...
                <div class="col-md-7 col-sm-6 col-xs-12 location-hrs" style="">
                 <%--<div class="miami-text">
                    ...
                    <div class="miami-text">
                        ...
                        <p> Mon-Sat &nbsp; 10AM - 6PM EST | <span>Sun &nbsp; Closed
                                            </span> </p>
                     </div>
                    <div class="miami-text">
                        <h4>call us @ 888-203-2131 </h4>
                        <p>3100 Sade Park Lane, Sanford, <span>FL 32771</span> </p>
                     </div>
                    <div class="miami-button">
                        <a href="https://www.google.com/maps/place/3100+Sade+Park+Ln,+Sanford,+FL+32771/@28.8006264,-81.3078856,15z/data=!4m5!3m4!1s0x88e712fb25922b03:0xb6cc40873f219739!8m2!3d28.8011144!4d-81.3032322" target="_blank">
        ...
        <div class="container">    
            <div id="third-section" class="col-md-12 col-sm-12 col-xs-12"> 			    
                <div class="miami-content">
                        <h4>AUTOBUY | SELL YOUR USED CAR IN SANFORD, FL 32771</h4>
                   
                   
                    <p>
                   Welcome to AUTOBUY, Citizens of Sanford Florida. We are Florida’s Largest Car Buying Company and the first to offer cash for cars. We have bought cars for cash from over 1,00,000 + customers from all over Florida. Now, we have opened our latest location at the city of Sanford. 
                    </p>
                    <p>
              ...
              <p>
             Why wait Sanford, get on your phones and call <span style="color:#274e9d;font-weight:bold">888-247-4257</span> right now! 
...
<div class="container-fluid" style="background:#303030;clear: left;margin-top:0px;">
        <div class="miami-text">
            <h4 style="margin-bottom:0px;padding:30px">Sanford contact details</h4>
        </div>
</div>
                ...
                return false;
                    ...
                    if (document.getElementById("<%=hidden_leadid.ClientID%>").value == "") {
                      //  document.getElementById("inner-submit_next").disabled = false;
                        ...
                        $.ajax({
                            type: "POST",
                            url: "Sell-my-car-sanford.aspx/buttonNxt_Click",
