...
public partial class Sell_my_car_sanford : System.Web.UI.Page
{
    ...
    //            scheduled_email.Insert_lead_new(txt_fname.Text.Trim(), txt_lname.Text.Trim(), txt_email.Text.Trim(), txt_phone.Text.Trim(), year/*Drp_Year.SelectedItem.Text*/, make /*hiddenMake.Value*/,
    //            model /*hidden_model.Value*/, txt_vinno.Text, txt_mileage.Text, hiddensource.Value.ToString(), url, from_website.Value, source_visit.Value, Local_ip.Value, get_lead_type.Value,
    //              drp_pref_loc.SelectedValue.ToString(), txt_zip.Text, txt_city.Text, txt_address.Text, type);
