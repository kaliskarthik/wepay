...
<%@ Page Title="Miami" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Selling-a-car-cutler-bay.aspx.cs" Inherits="miami" EnableEventValidation="false"  ValidateRequest = "false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">

 <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Sell my car Cutlerbay | Cash for car Cutlerbay | Car buyers Cutlerbay</title>
<link rel="canonical" href="http://183.82.32.95:8079/miami.aspx" />		
		<meta name="keywords" content="Used Cars, Sell car in culter bay,Car buying company" />

        <meta name="title" content="Sell my car Cutlerbay |cash for Cutlerbay | car buyers Cutlerbay" />

		<meta name="description" content="AUTOBUY, Florida's top car buying company has expanded to its ninth and newest location at Cutler Bay, Florida. Owing to our incredible success at Miami, we have expanded to our new location to provide the best of our services to Cutler Bay." />
...
<div id="image-location" class="col-md-6" style="padding:0">
  ...
  <img id="img-display" class="animated zoomIn" src="image/cutler-bay.jpg" alt="miami carbuyers"/>
                        ...
                        <div id="second-section" class="col-md-12 col-sm-12 col-xs-12">
                            <div class="col-md-5 col-sm-6 col-xs-12" style="">
                                <div class="img-review">
                                    <figure>
                            <img src="image/cbl.png" alt="Sell Your Car Miami" style="width:auto;margin-top: 10%;"/>
                            <figcaption style="margin-top:8%"><!--<h4 style="color:#fff">MIAMI</h4><br>-->
                                <div class="miami-button">
                                    <a href="https://www.google.com/search?q=Autobuy&amp;ludocid=18336739702411505971#lrd=0x0:0xfe792f9b6d0a3133,1" target="_blank">
                           ...
                           <%-- <div class="miami-text">
                                ...
                                <div class="miami-text">
                                    <h4 style="color:#FFEB3B">
                                        Location Hours</h4>
                                    <p>
                                        Mon-Fri &nbsp; 10AM - 7PM EST | Sat &nbsp; 9AM - 6PM EST | <span>Sun &nbsp; 12PM - 5PM
                                            EST</span>
                                    </p>
                                </div>
                                <div class="miami-text">
                                    ...
                                    <p> 
                                       20302 S Dixie Hwy, Cutler Bay, <span>FL 33189</span>
                                    </p>
                                </div>
                                <div class="miami-button">
                ...
                <div class="container">
                    <div id="third-section" class="col-md-12 col-sm-12 col-xs-12">
                        <div class="miami-content">
                            <h4>
                                AUTOBUY | SELL YOUR CAR IN CUTLER BAY, FL 33189</h4>
                            <p>
                               Over the past 8 years, the demand for cash for cars, online car buyers, and instant car buying companies has been growing throughout the united states and especially here in Florida. AUTOBUY, being one of Florida's largest car buying companies expanded to across 8 different locations within a span of 5 years with many of them started in the past two years. 
                            </p>
                            <p>
                               Miami, Florida is a massive city and it is the go to metropolis to many surrounding towns in the state. However, our AUTOBUY store at Miami, Florida was indeed a favorite for many used car owners. Invigorated and staggered at the response of our customers in Miami, we quickly needed to relieve the pressure on the store by opening a new location which is still accessible from Miami. 
                                </p>
                            <p>
                               Cutler Bay or Lakes by the Bay region seemed to be a prime spot for a high number of our customers and hence our 9th and newest AUTOBUY location is now open for customers at Cutler bay. Being the latest location, customers visiting the store would benefit from all the different options AUTOBUY has to offer. 
</p>
                            <p>Like every other location throughout the United States, even here at Cutler Bay AUTOBUY purchases all kinds of automobiles from cars, motorcycles, luxury cars, commercial vehicles, RVs, SUVs, Motor Homes, Camper Vans, Trucks, and even boats! 
</p>
                           <p>If you live anywhere in Cutler Bay or neighboring cities around Miami, Florida, you can now drive in with your used car and walk out with check in hand. Our appraisal process takes under 20 minutes and our offer stands good for 5 days in case you would like to check if we indeed pay the max. 
</p>
                            <p>You no longer have to settle for less, AUTOBUY for the max! 
</p>
                        </div>
                    </div>
                </div>
                ...
                if (atpos < 1 || dotpos < atpos + 2 || dotpos + 2 >= x.length) {
                    ...
                    if (document.getElementById("<%=hidden_leadid.ClientID%>").value == "") {
                      //  document.getElementById("inner-submit_next").disabled = false;
                        ...
                        $.ajax({
                            type: "POST",
                            url: "Selling-a-car-cutler-bay.aspx/buttonNxt_Click",
