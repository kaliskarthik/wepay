<%@ Page Title="Contact Us" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Contact.aspx.cs" Inherits="Contact" EnableEventValidation="false"  ValidateRequest = "false" %>
...
<!-- Basic Page Needs
  –––––––––––––––––––––––––––––––––––––––––––––––––– -->
   ...
   <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>AutoBuy-Miami|WPB|Margate|Stuart|Melbourne|Daytona|Orlando|Sanford|Florida</title>
    <link rel="canonical" href="http://183.82.32.95:8079/Contact.aspx" />
    <meta name="keywords" content="sell my car near me,Sell My car Miami,car buyers Fort Lauderdale,Autobuy, Car buyers west palm beach,sell used car melbourne" />
    <meta name="title" content="AutoBuy-Miami,WestPalmBeach,Margate,Stuart,Melbourne,Daytona,Orlando,Sanford" />
    <meta name="description" content="Autobuy has locations throughout South Florida. Click Here to find your closest location or to schedule your free appraisal. We can even come to you!" />

    <style type="text/css">
       .txtploc {padding-left:20px;}
       .hrs-center{width: 45%;}
...
<div id="contact-bg" class="container-fluid" style="">
...
<div id="first-section" class="col-md-12 col-sm-12 col-xs-12">			
                 <div id="contact-text-res" class="miami-text">
                        <h1>CONTACT AUTOBUY</h1>
                        <p>The team at AUTOBUY is waiting to hear from you! You can call and speak to any one <br/> of our experienced staff members during our business hours, <br/> or you can send us an email and someone will get back to you soon.</p>
                </div>   
...
<div class="col-md-12 col-sm-12 col-xs-12 sell">
	<div class="miami-content" style="padding-bottom:0px;">
        ...
        <span class="icon-locations ct-page-icons"></span>
		<h4>LOCATIONS </h4>
		<!--<h5>Fast 	&amp; Simple Selling Experience</h5>-->
		</div>
        <div class="container">   
            <div class="col-md-12 col-sm-12 col-xs-12 lib-item" data-category="view" style="margin-top: 20px;">
                <div class="lib-panel">
                    <div class="row">
                        <div class="col-md-5 col-sm-12 col-xs-12" style="padding:0;">
                            <div class="img-libray">
                                <img class="lib-img-show" src="image/miami-factory-loc.jpg" alt="sell my old car">
                            </div>    
                        </div>
                        <div class="col-md-7 col-sm-12 col-xs-12">
                            <div class="miami-content">
                <h4 class="contact-h4">miami</h4>
                </div>
                        <div class="col-md-6 col-sm-6 col-xs-6 border-location">
                       
                            <div class="miami-content">
                                <h4 style="text-align:left">Location Hours</h4>
                                <p><span class="hrs-center">Mon-Fri </span> 10AM - 7PM EST
                                    <br/> <span class="hrs-center">Sat</span>  9AM - 6PM EST 
                                    <br/><span class="hrs-center">Sun</span>  12PM - 5PM EST </p>
                             </div>
                             
                            <div class="miami-content">
                                <h4 style="text-align:left">call us @ 305-363-3161</h4>
                                <p>305-363-3161, <br/>2001 NW 167th ST,<br/> Miami Gardens,<br/> FL 33056 </p>
                             </div>
                        </div>
                       <div class="col-md-6 col-sm-6 col-xs-6 ">
                           <div class="miami-content">
                                <div class="contact-div" style="">
                                    <p class="con-dir"></p>
                                <p style="margin-left:70px;margin-bottom:0px;line-height:40px;"><a href="https://www.google.com/maps/place/2001+NW+167th+St,+Miami+Gardens,+FL+33056,+USA/@25.927253,-80.234911,17z/data=!3m1!4b1!4m2!3m1!1s0x88d9afb4f882d227:0x6bb461cec7e8be64" target="_blank">Click Here For Directions</a></p>
                                </div>
                                <div class="contact-div" style="">
                                    <p class="con-gplus"></p>
                                <p style="margin-left:70px;margin-bottom:0px;line-height:40px;"><a href="https://www.google.com/search?q=Autobuy&ludocid=18336739702411505971#lrd=0x0:0xfe792f9b6d0a3133,1" target="_blank">Review This Location</a></p>
                                </div>
                                <div class="contact-div" style="">
                                    <p class="con-yelp"></p>
                                <p style="margin-left:70px;margin-bottom:0px;line-height:40px;"><a href="https://www.yelp.com/writeareview/biz/UJ1yeP6T2eXu5b408qoPgw?return_url=%2Fwriteareview%2Fsearch%3Fwar_desc%3Dautobuy%26war_loc%3Dfort%2Blauderdale" target="_blank">View Yelp Reviews</a></p>
                                </div>
                                <div class="contact-div" style="">
                                    <p class="con-yelp"></p>
                                <p style="margin-left:70px;margin-bottom:0px;line-height:40px;"><a href="https://www.yelp.com/writeareview/biz/UJ1yeP6T2eXu5b408qoPgw?return_url=%2Fwriteareview%2Fsearch%3Fwar_desc%3Dautobuy%26war_loc%3Dfort%2Blauderdale" target="_blank">Add Yelp Review</a></p>
                                </div>
                            </div>
                        </div>
                        </div>    
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 lib-item" data-category="view" style="margin-top: 20px;">
                <div class="lib-panel">
                    <div class="row">
                        <div class="col-md-5 col-sm-12 col-xs-12" style="padding:0;">
                            <div class="img-libray">
                                <img class="lib-img-show" src="image/fort-factory-loc.jpg" alt="sell my car fast">
                            </div>    
                        </div>
                        <div class="col-md-7 col-sm-12 col-xs-12">
                            <div class="miami-content">
                <h4 class="contact-h4">fort lauderdale</h4>
                </div>
                        <div class="col-md-6 col-sm-6 col-xs-6 border-location">
                            ...
                            <div class="miami-content">
                                <h4 style="text-align:left">call us @ 954-532-2260</h4>
                                <p>954-532-2260, <br/>301 N State Road 7,<br/> Margate,<br/> FL 33063 </p>
                             </div>
                        </div>
                       <div class="col-md-6 col-sm-6 col-xs-6">
                           <div class="miami-content">
                                <div class="contact-div" style="">
                                    <p class="con-dir"></p>
                                <p style="margin-left:70px;margin-bottom:0px;line-height:40px;"><a href="https://www.google.com/maps/place/301+N+State+Rd+7,+Margate,+FL+33063/@26.233449,-80.205169,17z/data=!3m1!4b1!4m2!3m1!1s0x88d9048c3db24cf9:0xacb6feae8da991dd" target="_blank">Click Here For Directions</a></p>
                                </div>
                                <div class="contact-div" style="">
                                    <p class="con-gplus"></p>
                                <p style="margin-left:70px;margin-bottom:0px;line-height:40px;"><a href="https://www.google.com/search?q=Autobuy&ludocid=1961847053230509990#lrd=0x0:0x1b39e18027738fa6,1" target="_blank">Review This Location</a></p>
                                </div>
                                <div class="contact-div" style="">
                                    <p class="con-yelp"></p>
                                <p style="margin-left:70px;margin-bottom:0px;line-height:40px;"><a href="https://www.yelp.com/writeareview/biz/UJ1yeP6T2eXu5b408qoPgw?return_url=%2Fwriteareview%2Fsearch%3Fwar_desc%3Dautobuy%26war_loc%3Dfort%2Blauderdale" target="_blank">View Yelp Reviews</a></p>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 lib-item" data-category="view" style="margin-top: 20px;">
                <div class="lib-panel">
                    <div class="row">
                        <div class="col-md-5 col-sm-12 col-xs-12" style="padding:0;">
                            <div class="img-libray">
                                <img class="lib-img-show" src="image/palm-factory-loc.jpg" alt="How to sell my car fast">
                            </div>    
                        </div>
                        <div class="col-md-7 col-sm-12 col-xs-12">
                            <div class="miami-content">
                <h4 class="contact-h4">palm beach county</h4>
                </div>
                        <div class="col-md-6 col-sm-6 col-xs-6 border-location">
                            ...
                            <div class="miami-content">
                                <h4 style="text-align:left">call us @ 561-797-2400</h4>
                                <p>561-797-2400, <br/>1500 Belvedere Road,<br/> West Palm Beach,<br/> FL 33406 </p>
                             </div>
                        </div>
                       <div class="col-md-6 col-sm-6 col-xs-6" >
                           <div class="miami-content">
                                <div class="contact-div" style="">
                                    <p class="con-dir"></p>
                                <p style="margin-left:70px;margin-bottom:0px;line-height:40px;"><a href="https://www.google.com/maps?q=1500+Belvedere+Road+West+Palm+Beach,+FL+33406&oe=utf-8&um=1&ie=UTF-8&sa=X&ei=yzvVVKynLIzsoASIkYLgDQ&ved=0CAgQ_AUoAQ" target="_blank">Click Here For Directions</a></p>
                                </div>
                                <div class="contact-div" style="">
                                    <p class="con-gplus"></p>
                                <p style="margin-left:70px;margin-bottom:0px;line-height:40px;"><a href="https://www.google.com/search?q=Autobuy&ludocid=6503488070620706662#lrd=0x0:0x5a4107f17a567766,1" target="_blank">Review This Location</a></p>
                                </div>
                                <div class="contact-div" style="">
                                    <p class="con-yelp"></p>
                                <p style="margin-left:70px;margin-bottom:0px;line-height:40px;"><a href="https://www.yelp.com/writeareview/biz/PyzSCT4CkDXwHU35mVVDrg?return_url=%2Fwriteareview%2Fsearch%3Fwar_desc%3Dautobuy%26war_loc%3Dwest%2Bpalm%2Bbeach" target="_blank">View Yelp Reviews</a></p>
                                </div>
                                <div class="contact-div" style="">
                                    <p class="con-yelp"></p>
                                <p style="margin-left:70px;margin-bottom:0px;line-height:40px;"><a href="https://www.yelp.com/writeareview/biz/PyzSCT4CkDXwHU35mVVDrg?return_url=%2Fwriteareview%2Fsearch%3Fwar_desc%3Dautobuy%26war_loc%3Dwest%2Bpalm%2Bbeach" target="_blank">Add Yelp Review</a></p>
                                </div>
                            </div>
                        </div>
                        </div>    
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 lib-item" data-category="view" style="margin-top: 20px;">
                <div class="lib-panel">
                    <div class="row">
                        <div class="col-md-5 col-sm-12 col-xs-12" style="padding:0;">
                            <div class="img-libray">
                                <img class="lib-img-show" src="image/coast-factory-loc.jpg" alt="Who buy used cars">
                            </div>    
                        </div>
                        <div class="col-md-7 col-sm-12 col-xs-12">
                            <div class="miami-content">
                <h4 class="contact-h4">Treasure Coast</h4>
                </div>
                        <div class="col-md-6 col-sm-6 col-xs-6 border-location">
                            ...
                            <div class="miami-content">
                                <h4 style="text-align:left">call us @ 772-210-5357</h4>
                                <p>772-210-5357, <br/>1957 SE Federal Hwy,<br/> Stuart,<br/> FL 34994 </p>
                             </div>
                        </div>
                       <div class="col-md-6 col-sm-6 col-xs-6">
                           <div class="miami-content">
                                <div class="contact-div" style="">
                                    <p class="con-dir"></p>
                                <p style="margin-left:70px;margin-bottom:0px;line-height:40px;"><a href="https://www.google.com/maps?q=1957+SE+Federal+Hwy+Stuart,+FL+34994&oe=utf-8&um=1&ie=UTF-8&sa=X&ei=6TvVVITBOI-rogTSx4DYCw&ved=0CAgQ_AUoAQ" target="_blank">Click Here For Directions</a></p>
                                </div>
                                <div class="contact-div" style="">
                                    <p class="con-gplus"></p>
                                <p style="margin-left:70px;margin-bottom:0px;line-height:40px;"><a href="https://www.google.com/search?q=Autobuy&ludocid=17973348394501783329#lrd=0x0:0xf96e29234e9dbf21,1" target="_blank">Review This Location</a></p>
                                </div>
                                <div class="contact-div" style="">
                                    <p class="con-yelp"></p>
                                <p style="margin-left:70px;margin-bottom:0px;line-height:40px;"><a href="https://www.yelp.com/writeareview/biz/BoQME6jdXWHfxkAbDi0pjA?return_url=%2Fwriteareview%2Fsearch%3Fwar_desc%3Dautobuy%26war_loc%3Dstuart" target="_blank">View Yelp Reviews</a></p>
                                </div>
                                <div class="contact-div" style="">
                                    <p class="con-yelp"></p>
                                <p style="margin-left:70px;margin-bottom:0px;line-height:40px;"><a href="https://www.yelp.com/writeareview/biz/BoQME6jdXWHfxkAbDi0pjA?return_url=%2Fwriteareview%2Fsearch%3Fwar_desc%3Dautobuy%26war_loc%3Dstuart" target="_blank">Add Yelp Review</a></p>
                                </div>
                            </div>
                        </div>
                        </div>    
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 lib-item" data-category="view" style="margin-top: 20px;">
                <div class="lib-panel">
                    <div class="row">
                        <div class="col-md-5 col-sm-12 col-xs-12" style="padding:0;">
                            <div class="img-libray">
                                <img class="lib-img-show" src="image/melbourne-factory-loc.jpg" alt="sell my car melbourne">
                            </div>    
                        </div>
                        <div class="col-md-7 col-sm-12 col-xs-12">
                            <div class="miami-content">
                <h4 class="contact-h4">melbourne</h4>
                </div>
                        <div class="col-md-6 col-sm-6 col-xs-6 border-location">
                            ...
                            <div class="miami-content">
                                <h4 style="text-align:left">call us @ 321-206-3887</h4>
                                <p>321-206-3887, <br/>223 East New Haven Ave,<br/> Melbourne,<br/> FL 32901  </p>
                             </div>
                        </div>
                       <div class="col-md-6 col-sm-6 col-xs-6">
                           <div class="miami-content">
                                <div class="contact-div" style="">
                                    <p class="con-dir"></p>
                                <p style="margin-left:70px;margin-bottom:0px;line-height:40px;line-height:40px;"><a href="https://www.google.com/maps/place/223+E+New+Haven+Ave,+Melbourne,+FL+32901/@28.0783451,-80.6189772,17z/data=!3m1!4b1!4m5!3m4!1s0x88de11f1432a7167:0x5e6ed928c63bd537!8m2!3d28.0783451!4d-80.6167885" target="_blank">Click Here For Directions</a></p>
                                </div>
                                <div class="contact-div" style="">
                                    <p class="con-gplus"></p>
                                <p style="margin-left:70px;margin-bottom:0px;line-height:40px;line-height:40px;"><a href="https://www.google.co.in/search?q=google+my+business&rlz=1C1CHWA_enIN652IN652&oq=google+my+bu&aqs=chrome.0.0j69i60l3j69i57j0.4594j0j7&sourceid=chrome&ie=UTF-8#q=autobuy+melbourne&lrd=0x88de11f143270a6f:0x4c0312dbc7c4ab72,1" target="_blank">Review This Location</a></p>
                                </div>
                                <div class="contact-div" style="">
                                    <p class="con-yelp"></p>
             ...
             <div class="col-md-12 col-sm-12 col-xs-12 lib-item" data-category="view" style="margin-top: 20px;">
                <div class="lib-panel">
                    <div class="row">
                        <div class="col-md-5 col-sm-12 col-xs-12" style="padding:0;">
                            <div class="img-libray">
                                <img class="lib-img-show" src="image/sanford-new.jpg" alt="vehicle buyers"/>
                            </div>    
                        </div>
                        <div class="col-md-7 col-sm-12 col-xs-12">
                            <div class="miami-content">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 lib-item" data-category="view" style="margin-top: 20px;">
                <div class="lib-panel">
                    <div class="row">
                        ...
                        <div class="col-md-7 col-sm-12 col-xs-12">
                            <div class="miami-content">
                <h4 class="contact-h4">Cutler Bay</h4>
                </div>
                        <div class="col-md-6 col-sm-6 col-xs-6 border-location">
                            ...
                            <div class="miami-content">
                                <h4 style="text-align:left">call us @ 305-363-3161</h4>  
                                <p>305-363-3161, <br/>20302 S Dixie Hwy,<br/> Cutler Bay,<br/>FL 33189 </p>
                             </div>
                        </div>
                       <div class="col-md-6 col-sm-6 col-xs-6 ">
                           <div class="miami-content">
                                <div class="contact-div" style="">
                                    <p class="con-dir"></p>
                                <p style="margin-left:70px;margin-bottom:0px;line-height:40px;"><a href="https://www.google.com/maps/place/20302+S+Dixie+Hwy,+Cutler+Bay,+FL+33189,+USA/@25.5785846,-80.3721642,17z/data=!3m1!4b1!4m5!3m4!1s0x88d9c37f1fbba2d5:0xe491c33391c25675!8m2!3d25.5785846!4d-80.3699755" target="_blank">Click Here For Directions</a></p>
                                </div>
                                <div class="contact-div" style="">
                                    <p class="con-gplus"></p>
                                <p style="margin-left:70px;margin-bottom:0px;line-height:40px;"><a href="https://www.google.com/search?q=Autobuy&ludocid=18336739702411505971#lrd=0x0:0xfe792f9b6d0a3133,1" target="_blank">Review This Location</a></p>
...
<div class="container-fluid" style="background:#303030;clear: left;margin-top:0px;">
        <div class="miami-text">
            <h4 style="margin-bottom:0px;padding:30px">contact details</h4>
        </div>
</div>
...
<div class="container-fluid" class="blog-fluid"> 
<div class="container">  
            <div id="first-section" class="col-md-12 col-sm-12 col-xs-12">	
                <div class="miami-content" style="padding-bottom:20px;padding-top:20px;">
                <%--<img src="image/blog-page.png" alt="blog-img" class="contact-icons"/>    --%>
                <span class="icon-comp ct-page-icons"></span>
                <h4>BLOG</h4>
                <!--<h5>Fast 	&amp; Simple Selling Experience</h5>-->
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="img-libray" style="width:100%">
                    <img src="image/blog.png" alt="blog-img"/>
                    </div>    
                </div>
                <div id="blog-cont" class="col-md-6 col-sm-6 col-xs-12">
                     <div class="miami-content">
                            <h4>Sell Your Car at The Right Time</h4>
                            <p>We all buy cars that we love and hope to enjoy for many years to come. But let’s face reality: at some point, we may need to sell the car.  When to sell your car, and who to sell your car to, are very important decisions, if you want to receive the maximum possible payment.</p>
                            <h4><a href="http://blog.wepaythemax.com" class="button-blog" target="_blank">Visit Our Blog</a></h4>
                    </div>   
                </div>    
            </div>
    </div>
...
<div class="col-md-12 col-sm-12 col-xs-12">
        <div class="miami-content">
         <span class="icon-play vid-icons"></span>
...
<script type="text/javascript">
                ...
                return false;
                    ...
                    if (document.getElementById("<%=hidden_leadid.ClientID%>").value == "") {
                      //  document.getElementById("inner-submit_next").disabled = false;
                        ...
                        $.ajax({
                            type: "POST",
                            url: "Contact.aspx/buttonNxt_Click",
    ...
    $(document).ready(function () {
        ...
        $("#sixth_dropdown").css('color', 'rgb(26, 55, 255)');
    ...
    <script type="text/javascript">
        ...
        function type_car() {
            ...
            var dd = document.getElementById('<%= get_lead_type.ClientID %>').value;
