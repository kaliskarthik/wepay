<%@ Page Title="Treasure Coast" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Treasure_coast.aspx.cs" Inherits="Treasure_coast" EnableEventValidation="false"  ValidateRequest = "false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">

<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Stuart Car Buyers | Sell Your Car Treasure Coast | Autobuy</title>
		<link rel="canonical" href="http://183.82.32.95:8079/Treasure_coast.aspx" />
		<meta name="keywords" content="sell my car stuart, sell my car for cash stuart, car buyres stuart,autobuy,we buy used cars,sell my used car stuart" />
        <meta name="title" content="Stuart Car Buyers | Sell Your Car Treasure Coast | Autobuy" />
		<meta name="description" content="Sell your car truck SUV or motorcycle today! AutoBuy in Stuart will pay THE MAX for your vehicle! Free appraisals and we come to you!" />
...
<div id="image-location" class="col-md-6" style="padding:0">
  <img id="img-display" class="animated zoomIn" src="image/coast-factory-loc.jpg" alt="suv's"/>
</div>
...
<div class="container-fluid" style="background-image: url(image/miami-bg.jpg);background-size: cover;clear: left;margin-bottom:20px;padding:0;margin-top:3%;">
...
<div id="second-section" class="col-md-12 col-xs-12 col-sm-12">			
                <div class="col-md-5 col-xs-12 col-sm-6" style="">
                    <div class="img-review">
                         <figure>
                            <img src="image/coast-place.png" alt="sell your suv" style="width:auto;"/>
                            <figcaption style="margin-top:-5%"><!--<h4 style="color:#fff">MIAMI</h4><br>-->
                                <div class="miami-button">
                                    <a href="https://www.google.com/search?q=Autobuy&amp;ludocid=17973348394501783329#lrd=0x0:0xf96e29234e9dbf21,1" target="_blank">
                ...
                <div class="col-md-7 col-xs-12 col-sm-6 location-hrs" style="">
                 <%--<div class="miami-text">
                    ...
                    <div class="miami-text">
                        <h4>call us @ 772-210-5357</h4>
                        <p>1957 SE Federal Hwy, Stuart, <span>FL 34994</span> </p>
                     </div>
                    <div class="miami-button">
                        <a href="https://www.google.com/maps?q=1957+SE+Federal+Hwy+Stuart,+FL+34994&amp;oe=utf-8&amp;um=1&amp;ie=UTF-8&amp;sa=X&amp;ei=6TvVVITBOI-rogTSx4DYCw&amp;ved=0CAgQ_AUoAQ" target="_blank">
        ...
        <div class="container">    
            <div id="third-section" class="col-md-12 col-xs-12 col-sm-12"> 			    
                <div class="miami-content">
                        <h4>AUTOBUY | SELL YOUR CAR FOR CASH IN STUART, FL 34994</h4>
                        <p>When you are ready to make a change, see what the Stuart car buyers at AUTOBUY can do for you. Our team of professionals provide a quick and easy process to sell your car, truck or SUV in Stuart, Florida.</p>
                    
                        <p>Simply call or email one of our car buying professionals at our Stuart location to schedule a free vehicle appraisal at your office or home. A certified AUTOBUY inspector will appraise your car and offer you cash on the spot.</p>
                    
                    <p>At AUTOBUY, we pay the most money for your car or motorcycle in Stuart, Florida. Contact our team of expert car buyers serving Stuart at <span style="color:#274e9d;font-weight:bold">772-210-5357</span> to get started!</p>
                </div>
            </div>
        </div>    
</div>
...
<div class="container-fluid" style="background:#303030;clear: left;margin-top:0px;">
        <div class="miami-text">
            <h4 style="margin-bottom:0px;padding:30px">Treasure Coast contact details</h4>
        </div>
</div>
                ...
                return false;
                    ...
                    if (document.getElementById("<%=hidden_leadid.ClientID%>").value == "") {
                      //  document.getElementById("inner-submit_next").disabled = false;
                        ...
                        $.ajax({
                            type: "POST",
                            url: "Treasure_coast.aspx/buttonNxt_Click",
