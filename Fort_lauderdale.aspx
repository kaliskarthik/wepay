...
<%@ Page Title="Fort Lauderdale" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Fort_lauderdale.aspx.cs" Inherits="Fort_lauderdale" EnableEventValidation="false"  ValidateRequest = "false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
 <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>Sell My Car For Cash | Car Buyers Fort Lauderdale | Margate</title>
		<link rel="canonical" href="http://183.82.32.95:8079/Fort_lauderdale.aspx" />
		<meta name="keywords" content="sell my car Fort Lauderdale,car buyers Fort Lauderdale,sell my car for cash  fort lauderdale" />
        <meta name="title" content="Sell My Car For Cash | Car Buyers Fort Lauderdale | Margate" />
		<meta name="description" content="Sell your car truck SUV or motorcycle today! AutoBuy in Ft. Lauderdale will pay THE MAX for your vehicle! Free appraisals and we come to you!" />
...
<div id="image-location" class="col-md-6" style="padding:0">
  <img id="img-display" class="animated zoomIn" src="image/fort-factory-loc.jpg" alt="sell car"/>
</div>
...
<div id="second-section" class="col-md-12 col-sm-12 col-xs-12">			
                <div class="col-md-5 col-sm-6 col-xs-12" style="">
                    <div class="img-review">
                         <figure>
                            <img src="image/fort-place.png" alt="car buyers fort lauderdale" style="width:auto"/>
                            <figcaption style="margin-top:-5%"><!--<h4 style="color:#fff">MIAMI</h4><br>-->
                                <div class="miami-button">
                                    <a href="https://www.google.com/search?q=Autobuy&amp;ludocid=1961847053230509990#lrd=0x0:0x1b39e18027738fa6,1" target="_blank">
                ...
                <%--<div class="miami-text">
                    ...
                    <div class="miami-text">
                        ...
                        <p>Mon-Fri &nbsp; 9AM - 8PM EST | Sat &nbsp; 9AM - 6PM EST | <span>Sun &nbsp; 12PM - 5PM EST</span> </p>
                     </div>
                    <div class="miami-text">
                        <h4>call us @ 954-532-2260</h4>
                        <p>301 N State Road 7, Margate, <span>FL 33063</span> </p>
                     </div>
                    <div class="miami-button">
                        <a href="https://www.google.com/maps/place/301+N+State+Rd+7,+Margate,+FL+33063/@26.233449,-80.205169,17z/data=!3m1!4b1!4m2!3m1!1s0x88d9048c3db24cf9:0xacb6feae8da991dd" target="_blank">
        ...
        <div class="container">    
            <div id="third-section" class="col-md-12 col-sm-12 col-xs-12"> 			    
                <div class="miami-content">
                        <h4>AUTOBUY | SELL YOUR CAR IN FORT LAUDERDALE, FL 33063</h4>
                        <p style="word-spacing:2px;">When you are ready to sell your car in Fort Lauderdale, the experienced team at AUTOBUY is here to help. Call today to speak to one of our knowledgeable staff members at <span style="color:#274e9d;font-weight:bold">954-532-2260 </span> or send us an email and an AUTOBUY representative will respond shortly.</p>
                        <p>Our car buying process is quick and easy, and we will come to you! We will schedule a free appraisal of your car at your home or office with one of our certified AUTOBUY inspectors. In as few as 20 minutes, our Fort Lauderdale car buyers will then provide you a written offer to buy your car. You will receive cash for your car the same day that you sell.</p>
                        <p>We pay the max for your car, truck, SUV or motorcycle SUV in Fort Lauderdale!</p>
                </div>
            </div>
        </div>    
</div>
...
<div class="container-fluid" style="background:#303030;clear: left;margin-top:0px;">
        <div class="miami-text">
            <h4 style="margin-bottom:0px;padding:30px">FORT LAUDERDALE contact details</h4>
        </div>
</div>
                ...
                return false;
                    ...
                    if (document.getElementById("<%=hidden_leadid.ClientID%>").value == "") {
                      //  document.getElementById("inner-submit_next").disabled = false;
                        ...
                        $.ajax({
                            type: "POST",
                            url: "Fort_lauderdale.aspx/buttonNxt_Click",
