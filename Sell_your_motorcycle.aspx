<%@ Page Title="Sell Your Motorcycle" Language="C#" MasterPageFile="~/MasterPage.master"
    AutoEventWireup="true" CodeFile="Sell_your_motorcycle.aspx.cs" Inherits="Sell_your_motorcycle" EnableEventValidation="false"  ValidateRequest = "false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <!-- Basic Page Needs
  –––––––––––––––––––––––––––––––––––––––––––––––––– -->
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>Sell My Motorcycle I Cash For Motorcycle | Autobuy Florida</title>
    <link rel="canonical" href="http://183.82.32.95:8079/Sell_your_motorcycle.aspx" />	
    <meta name="keywords" content="Sell your motorcycle,  sell my motorcycle,motorcycle buyers,cash for motorcycle,sell my used motorcycle" />
    <meta name="title" content="Sell My Motorcycle I Cash For Motorcycle | Autobuy Florida" />
   <meta name="description" content="With locations in Fort Lauderdale, West Palm Beach, Melbourne, Miami, and Stuart, Daytona, Orlando and Sanford, AutoBuy is the easiest way to sell your motorcycle." />
    ...
    <style>
        ...
        .icon_vehicles-border
        {
            ...
            border: 2px solid rgb(255, 102, 51) !important;
        }
        a.inner-submit
        {
            margin-right: 0;
...
<div id="image-wrapper" class="col-md-6" style="padding:0">
  <img id="img-display" class="animated zoomIn" src="image/bike_page_img.jpg" alt="Cash For Motorcycle" style="width:auto"/>
</div>    
							...
							<h3>JUST 20 MINS AWAY TO THE MAX</h3>
                                ...
                                <div>	
									...
									<div class="Row1">	
                                        ...
                                        <asp:HiddenField runat="server" ID="get_lead_type"  Value="2"/>
 ...
 <asp:HiddenField runat="server" ID="hiddenMake" Value="" />
  ...
  <a  class="inner-submit"  onclick="return source();" id="vehicle_info_next"  >Get Started</a>
    ...
    font-size: 20px;"></span>&nbsp;&nbsp;<span style="color: #e74c3c;">(888)428-8381</span></h3> 
        ...
        <ul>
            <li id="sell-form-bike" class="btn-sell btn-labeled-sell btn-default" style="margin-top:40px;"><span class="btn-label-sell"><i class="glyphicon glyphicon-chevron-right"></i></span><a href="javascript:void(0)" style="color:#000;font-weight:bold;text-transform: uppercase;">Submit Your Vehicle</a></li>
        </ul>
     </div>--%>
                    </div>
                </div>
                ...
                <div class="container">
                    <div id="third-section" class="col-md-12 col-sm-12 sell col-xs-12">
                        <div class="heading" style="padding-top: 0px; padding-bottom: 20px;">
                            <h2 class="sellmycar">
                                AUTOBUY, the "<span style="color: #e74c3c">Sell My Motorcycle</span>" Company!</h2>
                        </div>
                        <div class="miami-content">
                            <p>
                                If you are looking to sell your motorcycle, you have come to the right place, because
                                we are ‘the destination’ for buying motorcycles in the country. Get hassle free,
                                transparent and timely motorbike selling experience from the experts – AUTOBUY.
                                Motorcycles riders are usually much more aware and knowledgeable about their vehicle,
                                and many times they do find themselves disappointed with the offer they get to sell
                                their motorcycle. Just because people assume motorcycles don’t enjoy the same market
                                share as the cars, it is more difficult to sell motorcycles and consequently lesser
                                resale value. However, AUTOBUY being the leader in buying automobiles of all kinds,
                                has years of experience in appraising motorcycles. With us, you can be assured that
                                would get the best cash offer for your motorcycle. At AUTOBUY, we pay the Max.
                            </p>
                            <p>
                                Your motorcycle could be of any make ranging from Harleys, Suzuki, Kawasaki, KTM
                                to Custom Made choppers and dirt bikes, we will give you the best price. Being motorcycle
                                buyers, we have a highly refined and specialized process for buying your motorcycle
                                really fast. We also buy vehicles of any condition, age, mileage, make, model and
                                even if your motorcycle has a loan on it, damaged or has a pending insurance check.
                                Autobuy experts are trained professionals who make the experience of selling your
                                bike quick, reliable and without complications. When you leave the work to the experts,
                                you don’t have to worry about “how to sell your motorcycle”, because we will do
                                all the work for you. All you have to is to call 888-428- 8381 mention the details
                                of your vehicle and book an appointment for getting your motorcycle appraised.
                            </p>
                            <p>
                                You can also fill out the booking form listed in our website at wepaythemax.com
                                and enter your details. Once your appraisal schedule is booked, an AUTOBUY certified
                                appraiser would inspect your vehicle either at your home or work depending on your
                                convenience. Within 20 minutes, our appraiser will give you an offer that is valid
                                for 5 days. This gives you enough time to double check and get your vehicle appraised
                                by others too, but be sure, we usually pay more than your regular dealer would.
                                Over the years, there have been hundreds of happy motorcycle sellers who have benefited
                                from AUTOBUY services. Most importantly, you can get cash for your vehicle on the
                                same day the offer is made. So, you can book an appraisal, get your vehicle evaluated
                                and get it sold within in day at most times. So, you can get your cash when you
                                need it, to buy a new motorcycle or to spend it on your needs. AUTOBUY is the country’s
                                premier automobile buying company, to sell your motorcycle for the max value, Call
                                AUTOBUY now!
                            </p>
                        </div>
                    </div>
                ...
                if (atpos < 1 || dotpos < atpos + 2 || dotpos + 2 >= x.length) {
                    ...
                    if (document.getElementById("<%=hidden_leadid.ClientID%>").value == "") {
                      //  document.getElementById("inner-submit_next").disabled = false;
                        ...
                        $.ajax({
                            type: "POST",
                            url: "Sell_your_motorcycle.aspx/buttonNxt_Click",
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $('.form-menu').show();
            $('#change-icon-class').addClass('icon-bike icon_vehicles-border');
            $('.icon_vehicles-border').css('background', 'transparent');
            $('.icon_vehicles-border').css('line-height', '100px');
            $('.badge-1').css('background', '#FF6633', 'color', '#ffffff');
            $('#select-icon').addClass('fa fa-check');
            $('#change-icon-class').removeClass('icon-car icon-boat icon-Rv icon-cv');
            $('#change-icon-class,#select-icon').show();
            $('.inner-container h3').css('background', '#FF6633');
            $('.button-menu').toggleClass('orange-tab h2');
            $('a.inner-submit').css('background', 'url(image/submit-arrow.png) #FF6633');
            $('a.inner-submit').css('background-repeat', 'no-repeat');
            $('a.inner-submit').css('background-position', '85% 11px');
            $('a.inner-cancel').css('border', '2px solid #FF6633');
            $('a.inner-cancel').css('color', '#FF6633');
            $('a.inner-cancel').toggleClass('cancel-orange');
            $('input.step1').css('background', '#FF6633');
            $('.button-menu').removeClass('blue-tab h2 yellow-tab h2 green-tab h2 red-tab h2');
            $('a.inner-cancel').removeClass('cancel-blue cancel-yellow cancel-green cancel-red');
