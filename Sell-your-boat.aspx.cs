...
public partial class Sell_your_boat : System.Web.UI.Page
{
    ...
    //            scheduled_email.Insert_lead(txt_fname.Text.Trim(), txt_lname.Text.Trim(), txt_email.Text.Trim(), txt_phone.Text.Trim(),Drp_Year1.Text /*Drp_Year.SelectedItem.Text*/,drp_Carname1.Text /*hiddenMake.Value*/,
    //       /*     hidden_model.Value*/drp_Model1.Text, txt_vinno.Text, txt_mileage.Text, hiddensource.Value.ToString(), url, from_website.Value, source_visit.Value, Local_ip.Value, get_lead_type.Value,
