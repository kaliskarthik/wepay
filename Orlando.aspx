<%@ Page Title="Orlando" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Orlando.aspx.cs" Inherits="Orlando" EnableEventValidation="false"  ValidateRequest = "false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">

 <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>cash for car orlando | buy car orlando | cash car orlando</title>
<link rel="canonical" href="http://183.82.32.95:8079/Orlando.aspx" />
        ...
        <meta name="title" content="cash for car orlando | buy car orlando | cash car orlando" />
		<meta name="description" content="Sell your car, sell your truck, sell your Suv or motorcycle today! AutoBuy in Orlando will pay THE MAX for your vehicle! Free appraisals and we come to you!" />
...
<div id="image-location" class="col-md-6" style="padding:0">
  <img id="img-display" class="animated zoomIn" src="image/orlando-coming-soon.jpg" alt="sell your car orlando"/>
</div>
...
<div id="second-section" class="col-md-12 col-sm-12 col-xs-12">		
                ...
                <div class="col-md-5 col-sm-6 col-xs-12" style="">
                    <div class="img-review">
                         <figure>
                            <img src="image/orlando-place.png" alt="cash for car orlando" style="width:auto"/ >
                            <figcaption style="margin-top:-5%"><!--<h4 style="color:#fff">ORLANDO</h4><br>-->
                                <div class="miami-button">
                                    <a href="https://www.google.co.in/search?q=autobuy+orlando&rlz=1C1CHWA_enIN652IN652&oq=autobuy+orlando&aqs=chrome..69i57j69i60l3j69i59l2.3752j0j7&sourceid=chrome&ie=UTF-8#lrd=0x88e77dba846441e7:0xe098b1b569ef9a53,3" target="_blank">
                ...
                <%-- <div class="miami-text">
                    ...
                    <div class="miami-text">
                        ...
                        <p> Mon-Fri &nbsp; 9AM - 8PM EST | Sat &nbsp; 9AM - 6PM EST | <span>Sun &nbsp; 12PM - 5PM
                                            EST</span> </p>
                     </div>
                    <div class="miami-text">
                        <h4>call us @ 888-203-2131 </h4>
                        <p>1350 W Landstreet Rd, Orlando, <span>FL 32824</span> </p>
                     </div>
                    <div class="miami-button">
                        <a href="https://www.google.co.in/maps/place/AutoBuy+-+Orlando/@28.4354245,-81.399375,17z/data=!3m1!4b1!4m5!3m4!1s0x88e77dba846441e7:0xe098b1b569ef9a53!8m2!3d28.4354245!4d-81.3971863" target="_blank">
                            <button type="button" class="btn btn-direct">Click Here For Directions</button></a>
                     </div>
                </div> 	
        ...
        <div class="container">    
            <div id="third-section" class="col-md-12 col-sm-12 col-xs-12"> 			    
                <div class="miami-content">
                        <h4>AUTOBUY | SELL YOUR CAR IN ORLANDO, FL 32824</h4>
                   
                   
                    <p>
                    ORLANDO, Here we come! We buy Any Car, SUV, Truck, Motorcycles, RV’s, Commercial Vehicles and Boat’s from $1000 to $500,000
                    
                    
                    </p>
                    <p>
                    Autobuy, A car buying company, formed in the year 2010 has grown strong, with 70+ car buyers in south Florida region. We are the ONLY NATION’S TOP rated car buying company in google, who pays the MAX for your Car, SUV, Truck, Motorcycles, RV’s, Commercial Vehicles and Boat’s.
                    </p>
                    <p>
                    
                    Orlando, we make it easy for you, our certified Car Buyers come to your door steps, evaluate the vehicle, provide a MAX offer in less than 20 mins with on the spot Instant payment and your vehicle is SOLD. It is that EASY. Just take 30 seconds to fill your information, tell us your available date and time and we will be there right on time! Or call us at <span style="color:#274e9d;font-weight:bold">888-203-2131</span>  to get your home appointment.
                    </p>

                 <p>
                 
                 Do you have Lean on your title, Car Loans, Car Payments on your Car, SUV, Truck, Motorcycles, RV’s, Commercial Vehicles and Boat’s? We got you covered! We buy any car for the MAX, Our processing team will handle all the paper work with your Bank and Department of Transportation. 
                 
                 </p>
                   
              <p>
              You have no loans on your Car? It is simple, get cash on the spot! Yes! Sell your car for cash right at your home! We are the car buyers who can get the MAX for your vehicle.
              
              </p>
              <p>
              We made Car Selling the BEST experience for 50,000+ Happy Customers all over South Florida Region. Orlando, we are here to get the MAX for your Car, SUV, Truck, Motorcycles, RV’s, Commercial Vehicles and Boat’s
                ...
                return false;
                    ...
                    if (document.getElementById("<%=hidden_leadid.ClientID%>").value == "") {
                      //  document.getElementById("inner-submit_next").disabled = false;
                        ...
                        $.ajax({
                            type: "POST",
                            url: "Orlando.aspx/buttonNxt_Click",
