<%@ Page Title="How to Sell my Car | i want to sell my car |sell my car fast" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="How-to-sell-my-car-fast.aspx.cs" Inherits="Article_1"  EnableEventValidation="false"  ValidateRequest = "false"%>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
 ...
 <meta name="description" content="Make your car look presentable. Fix minor issues but don't overdo it, Don't spend too much fixing dents. To avoid all these hassles, sell your instantly AutoBuy for the Max" />
 <meta name="keywords" content="How to Sell my Car,How to Sell my Car fast,I want to sell my car fast" />
...
<div id="article-div" class="miami-content">
    <h1>How to Sell My Car Fast?</h1>
 </div>
<img class="col-md-8 col-md-offset-2" src="image/article-1.jpg" alt="I want to sell my car" style="margin-bottom:25px;"/>
<div id="" class="col-md-8 col-md-offset-2">
        <div class="miami-content">
            <ul>
                <li id="sell-form-article-1" class="btn-sell btn-labeled-sell btn-default" style="margin-top:0;margin-bottom:12px;">
        ...
        <div class="miami-content">
           <p>A recent study conducted in United States showed statistics that for every new car that is bought, there are 3 used cars that are sold. With new cars entering the market every day, the used car market is also on the rise. Selling your used car for the right value has its complications. Here are few ways to sell your car fast and save time and money while doing so. </p>
            <p>The difference between selling your car fast and late impacts in various ways. In some cases when people makes very common mistakes while selling their car,  it delays the process by a long way. When a used car which is up for sale, is not sold for a long period of time, then it is highly improbable for selling it at a price that you desire. This is why when you decide to sell your used car, you have to sell it as fast as possible. </p>
            <p><b>Prepare your car for sale</b></p>
            <p>The first question is to ask yourself ‘if you would buy the car in the way it is presented to the buyer?’ The first thing you have to do is make your car look presentable. Nobody would buy your car with your used tissues or pet stains on it. Give it for good vacuuming, you could probably foam wash it and wax it to give a shinning look. However, it is also important that you don’t overdo it, as spending too much like replacing the tires or fixing dents would not greatly improve the value of your vehicle. </p>
            <p><b>Get a Good Quote</b></p>
            <p>You may get a quote from either a trusted dealer or from an online site. But it always wise to get quotes on your vehicle from multiple dealers. This would help you get an estimate of how much your used car is actually worth. You can also fill out a form at wepaythemax.com and get free estimate done right at the comfort of your home in less than 20 minutes. Once you collect about 3-5 estimates, you can use the average to set a price for selling your car. If you quote it for a much higher value, you might not be able to sell your car quickly.</p>
            <p><b>Ensure your buyer takes a test drive</b></p>
            <p>If you are selling your used car in person to your potential buyer, always ensure that the buyer takes a test drive before negotiating on the price. Try to accompany the buyer while he/she is taking a test drive as it would help your gauge how interested they are in buying your car. This could probably help you sell it to them quicker and even at a higher price than you expected.</p>
             <p><b>The Fastest Way</b></p>
            <p>When you have made up your mind to sell your car, just call <span style="color:#274e9d"><a href="tel:8884288381">888-428-8381</a></span> or fill up our form online for a free appraisal. Within 20 minutes, a certified AUTOBUY professional will provide an accurate estimate on your vehicle. You can be sure that the price we offer would be the max offer you would get for your vehicle. Because at AUTOBUY, We Pay the Max. With AUTOBUY, you can sell your car at any condition, any mileage, and even if you have a loan on it. The best aspect is that you’ll get paid the same day you sell your car. Selling your car on AUTOBUY is the fastest and easiest way to sell your used car.   </p>
             <%--<p><b>Get a Good Quote</b></p>
            <p></p>
             <p><b>Get a Good Quote</b></p>
            <p></p>--%>
                ...
                return false;
                    ...
                    if (document.getElementById("<%=hidden_leadid.ClientID%>").value == "") {
                      //  document.getElementById("inner-submit_next").disabled = false;
                        ...
                        $.ajax({
                            type: "POST",
                            url: "How-to-sell-my-car-fast.aspx/buttonNxt_Click",
