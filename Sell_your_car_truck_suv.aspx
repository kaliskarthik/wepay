<%@ Page Title="Sell Your Car, Truck, Suv" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Sell_your_car_truck_suv.aspx.cs" Inherits="Sell_your_car_truck_suv" EnableEventValidation="false"  ValidateRequest = "false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
 <!-- Basic Page Needs
  –––––––––––––––––––––––––––––––––––––––––––––––––– -->
  <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title> Selling your car for cash | Cash for Car Truck SUV | Used cars FL</title>
<link rel="canonical" href="http://183.82.32.95:8079/Sell_your_car_truck_suv.aspx" />		
        ...
        <meta name="title" content="Selling your car for cash | Cash for Car Truck SUV | Used cars FL" />
<meta name="description" content="With locations in Fort Lauderdale, Melbourne, West Palm Beach, Stuart, Miami, Daytona, Orlando and Sanford, AutoBuy is the easiest way to sell your car, truck, or Suv's." />
...
<div id="image-wrapper" class="col-md-6" style="padding:0">
  <img id="img-display" class="animated zoomIn" src="image/car_page_img.jpg" alt="whats my truck worth" style="width:auto"/>
</div>
...
<div class="container-fluid fast-steps">
        ...
        <ul>
            <li id="sell-form-car-truck" class="btn-sell btn-labeled-sell btn-default" style="margin-top:40px;"><span class="btn-label-sell"><i class="glyphicon glyphicon-chevron-right"></i></span><a href="javascript:void(0)" style="color:#000;font-weight:bold;text-transform: uppercase;">Submit Your Vehicle</a></li>
        </ul>
     </div>--%>
                    </div>
                </div>
        ...
        <div class="container">    
            <div id="third-section" class="col-md-12 col-sm-12 sell col-xs-12"> 	
                    <div class="heading" style="padding-top:0px;padding-bottom:20px;">
                        <h2 class="sellmycar">AUTOBUY, the "<span style="color:#e74c3c">Sell My Car</span>" Company!</h2>
		            </div>
                <div class="miami-content">
                ...
                return false;
                    ...
                    if (document.getElementById("<%=hidden_leadid.ClientID%>").value == "") {
                      //  document.getElementById("inner-submit_next").disabled = false;
                        ...
                        $.ajax({
                            type: "POST",
                            url: "Sell_your_car_truck_suv.aspx/buttonNxt_Click",
