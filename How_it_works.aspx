<%@ Page Title="How It Works" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="How_it_works.aspx.cs" Inherits="How_it_works" EnableEventValidation="false"  ValidateRequest = "false" %>
...
<title>How It Works | AutoBuy | South Florida Car Buying Company</title>
		<link rel="canonical" href="http://183.82.32.95:8079/How_it_works.aspx" />
        ...
        <meta name="title" content="How It Works | AutoBuy | South Florida Car Buying Company" />
		<meta name="description" content="There isn't a faster way to sell your car, truck, SUV, motorcycle, or commercial vehicle than with AUTOBUY. Click Here to Learn More!" />
...
.box-info-content .miami-content h5{line-height:30px !important;}
.box-info{height:350px !important;}
.box-info-content{margin-top:75px !important;}
}
...
<div id="first-section" class="col-md-12 col-sm-12 col-xs-12">			
                 <div id="contact-text-res" class="miami-text">
                        <h1>HOW TO SELL YOUR VEHICLE</h1>
                        <p>There isn't a faster way to sell your used car, truck, SUV, motorcycle, or commercial vehicle than with AUTOBUY. In as little as 20 minutes. <br />We will appraise your vehicle and produce a written OFFER TO BUY! The best part is we come to you!</p>
                        <ul>
                             <li id="sell-form" onclick="drponly1()" class="btn-sell btn-labeled-sell btn-default"><span class="btn-label-sell"><i class="glyphicon glyphicon-chevron-right"></i></span><a href="javascript:void(0)" style="color:#000;font-weight:bold;text-transform: uppercase;">Sell Your Vehicle</a></li>
                        </ul>
                </div>   
...
<div id="steps-div-text" class="container-fluid" style="background-color: #fff;clear:left;overflow-x:hidden;margin-top:50px;">
<div class="container cf">    
<div id="third-section" class="col-md-12 col-sm-12 sell col-xs-12" style="">
	<div class="how-works" style="margin-top: 20px;">
        <h3>follow these 3 steps </h3>
     <h4 style="color:#000">a certified Autobuy Appraiser will buy your vehicle for the <span style="color:#274e9d;font-weight:bold">max</span> </h4>
    </div>  
    			
<div class="col-md-4 col-sm-4 col-xs-12" style="margin-top: 65px;">
            <div class="box-info">
                  <div class="box-info-content">
                    <div class="miami-content">
                    <span class="icon icon-xl icon-primary fl-fill-round-icons-attachment1"></span>
                        <h5><b>SELL YOUR VEHICLE</b></h5>
                         <p>Call <span style="color:#274e9d;font-weight:bold"><a href="tel:8884288381">888.428.8381</a></span> to have an AUTOBUY associate guide you through our free appraisal process and arrange an appointment at your home or office. Or, you can navigate to one of our SELL YOUR VEHICLE pages and fill out the online form located there.</p>
                        </div>
                  </div>
                </div>
</div> 
<div class="col-md-4 col-sm-4 col-xs-12" style="margin-top: 65px;">
            <div class="box-info">
                  <div class="box-info-content"><span class="icon icon-xl icon-primary fl-fill-round-icons-attachment2"></span>
                    <div class="miami-content">
                        <h5><b>GET APPRAISAL</b></h5>
                         <p>Your car will be appraised by one of our professional AUTOBUY appraisers. The value includes considerations for mileage, year, make, model, interior/exterior damage and any additional factors that the appraiser might find. The appraisal can take as few as 20 minutes!</p>
                        </div>
                  </div>
                </div>
</div> 
<div class="col-md-4 col-sm-4 col-xs-12" style="margin-top: 65px;">
            ...
            <div class="box-info">
                  <div class="box-info-content"><span class="icon icon-xl icon-primary fl-fill-round-icons-attachment3"></span>
                    <div class="miami-content">
                        <h5><b>ACCEPT THE OFFER</b></h5>
                         <p>You will receive a written offer for your vehicle from AUTOBUY. You can choose to sell us your vehicle instantly or take up to 5 days to make your decision. An AUTOBUY associate will assist you with completing your vehicle purchase.</p>
                        </div>
                  </div>
                </div>
</div>   
<div class="miami-content">
        <ul>
            <li id="sell-form-1" onclick="drponly1()" class="btn-sell btn-labeled-sell btn-default" style="margin-top:30px;"><span class="btn-label-sell"><i class="glyphicon glyphicon-chevron-right"></i></span><a href="javascript:void(0)" style="color:#000;font-weight:bold;text-transform: uppercase;">Sell Your Vehicle</a></li>
        </ul>
     </div>
</div>
</div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#sell-form,#sell-form-1").click(function () {
        if ($(window).width() < 797) {
                ...
                return false;
                    ...
                    if (document.getElementById("<%=hidden_leadid.ClientID%>").value == "") {
                      //  document.getElementById("inner-submit_next").disabled = false;
                        ...
                        $.ajax({
                            type: "POST",
                            url: "How_it_works.aspx/buttonNxt_Click",
