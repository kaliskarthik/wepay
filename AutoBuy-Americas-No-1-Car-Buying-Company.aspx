<%@ Page Title="Americas No 1 Car Buying Company Sell Your Car for the Max | AutoBuy" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AutoBuy-Americas-No-1-Car-Buying-Company.aspx.cs" Inherits="Article_2" EnableEventValidation="false"  ValidateRequest = "false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">

<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />

 <meta name="description" content="AutoBuy being the leading car buying company in the country, will offer you the Max you would get for your vehicle. It's the fastest way to sell your car online" />
 <meta name="keywords" content="sell my used car,sell my car online,sell car,buy my car,used cars near me,buy used cars,Whats my car worth,sell used car" />
...
<div id="article-div" class="miami-content">
    <h1> AutoBuy Americas #1 Car Buying Company </h1>
 </div>
<img class="col-md-8 col-md-offset-2" src="image/article-2.jpg" alt="sell used car" style="margin-bottom:25px;"/>
<div id="" class="col-md-8 col-md-offset-2">
        <div class="miami-content">
            <ul>
                <li id="sell-form-article-2" class="btn-sell btn-labeled-sell btn-default" style="margin-top:0;margin-bottom:12px;">
        ...
        <div class="miami-content">
           <p>Selling your car is a time consuming process. It takes a lot of time and energy to sell your car privately on your own. But, sometimes selling it to a dealer or to trade in your car is not ideal. As the dealer would have to pay a legal fee for purchasing your car, they would ideally offer your car a much lower value. So what is the best way to sell your car for the max? The way ahead is to find the best car buying company in United States.  </p>
           <p>Selling your car at wepaythemax.com is your ideal option to sell your car for the max price. Several hundreds of happy customers have sold their car on AUTOBUY for the MAX. When selling your used vehicle, two aspects are of primary importance, time and money. You should be able to sell your used car in quick time to be able to purchase your new vehicle. Secondly, you should ensure that you get the best possible price for your used vehicle.</p>
            <p>AUTOBUY has got you covered in these two aspects. Selling your car on AUTOBUY is simple, easy, convenient, fast, and of course you get the max price. We buy trucks, SUVs, Cars, Motorcycles, Hybrids and much more. There are 3 simple steps to sell your car on AUTOBUY for the max. </p>
             <p><b>Make a decision:</b></p>
            <p>When you have made a decision to sell your used car, you have two ways of letting us know. You can call <span style="color:#274e9d"><a href="tel:8884288381">888-428-8381</a></span> and speak to an AUTOBUY associate would guide you through the process and schedule an appointment. If you are a tech savvy person and like to handle things on the internet on your own, then could visit wepaythemax.com and fill in the form there entering the details of your vehicle.s</p>
             <p><b>Get it Appraised:</b></p>
            <p>Once you have given us your car’s information, a certified AUTOBUY appraiser would come in at a time of your convenience either to your home or office to appraise your vehicle. You don’t have to make changes to your busy schedule to accommodate time to get your car appraised. The appraiser would value model, make, year, mileage, interior/exterior damage and other factors there may be and give you an estimate in under 20 minutes. </p>
            <p><b>Get Paid:</b></p>
            <p>Once your car is appraised, you would receive an offer for your vehicle from AUTOBUY. If you are in a hurry, you can sell your car on the same day. If you are a bit skeptical, you can also search around for better offers for 5 days. Being the leading car buying company in the country, AUTOBUY will offer you the Max you would get for your vehicle. An AUTOBUY expert would guide at every step of your way till your vehicle is sold and you receive your cash at hand.</p>
            <p>Take note, AUTOBUY would purchase your vehicle even if it has a loan on it, has a pending insurance check, if it’s damaged, and even if you have an out-of-state title. AUTOBUY is among the leading car buying companies in USA and the best option to sell your used car. </p>
        </div>
   </div>
</div>
</div>
                ...
                return false;
                    ...
                    if (document.getElementById("<%=hidden_leadid.ClientID%>").value == "") {
                      //  document.getElementById("inner-submit_next").disabled = false;
                        ...
                        $.ajax({
                            type: "POST",
                            url: "AutoBuy-Americas-No-1-Car-Buying-Company.aspx/buttonNxt_Click",
