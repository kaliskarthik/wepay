...
public partial class Autobuy : System.Web.UI.Page
{
    ...
    protected void DropDownList3_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        SqlConnection con = new SqlConnection(connString);
        con.Open();
        SqlCommand cmd = new SqlCommand("select model from carlist where [car_year]=@yrs and make=@cname and model <>''", con);
