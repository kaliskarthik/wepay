<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="car-trade-in-value.aspx.cs" Inherits="car_trade_in_value"  EnableEventValidation="false"  ValidateRequest = "false"%>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
 <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Orlando Car Buyers | NEVER TRADE IN CAR FOR MINIMUM SELL TO AUTOBUY FOR MAX | Autobuy</title>
        ...
        <meta name="title" content="Orlando Car Buyers | NEVER TRADE IN CAR FOR MINIMUM SELL TO AUTOBUY FOR MAX | Autobuy" />
                ...
                return false;
                    ...
                    if (document.getElementById("<%=hidden_leadid.ClientID%>").value == "") {
                      //  document.getElementById("inner-submit_next").disabled = false;
                        ...
                        $.ajax({
                            type: "POST",
                            url: "car-trade-in-value.aspx/buttonNxt_Click",
